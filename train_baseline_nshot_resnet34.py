...
def main_exp(args):
    ...
    LOG_PATH = f"experiment_log_lambda{args.lambda_mmd}_baseline_{args.n_shot}shot_resnet34.csv"
    ...
    model_name = f"saved_models/resnet34_baseline_nshot{args.n_shot}_lambdares{args.lambda_residual}_lambdammd{args.lambda_mmd}_seed{args.seed}_epoch{epoch+1}.pth"
